  ...
  <Layout title="2020 Resolutions" color="red" heroImageName="dslc">
    ...
    <div className="sidebar">
      ...
      <ul>
        ...
        <li>
          <InternalLink to="national-political-education">
            Developing a Robust National Political Education Program
          </InternalLink>
        </li>
        <li>
          <InternalLink to="rank-and-file-pipeline">
            Establishing a YDSA Rank-and-File Pipeline
          </InternalLink>
        </li>
        <li>
          <InternalLink to="growth-and-diversification">
    ...
    <div className="content" id="wws">
      ...
      >
        ...
        <h3>
          ...
          <br />
          <strong>Co-sponsors:</strong> Griffin Mahon, YDSA at University of
          Virginia
          <br /> Neah Havens, Western Washington University YDSA
        </h3>
        <p>
          <em>
        ...
        <p>
          <em>
            ...
            Perspectives Document for YDSA!
          </em>
        </p>
        <p>
      ...
      <Element
        name="national-political-education"
        id="national-political-education"
      >
        <h2>Developing a Robust National Political Education Program</h2>
        <h3>
          <strong>Sponsor:</strong> Emmaline Bennett, Columbia-Barnard
          <br />
          <strong>Co-sponsors:</strong> Josh Kuh, Kalamazoo
          <br /> Michael Stenovec, UCLA
        </h3>
        <p>
          <em>
      ...
      <Element name="rank-and-file-pipeline" id="rank-and-file-pipeline">
        <h2>Establishing a YDSA Rank-and-File Pipeline</h2>
        <h3>
          <strong>Sponsor:</strong> Griffin Mahon (UVa)
          <br />
          <strong>Co-sponsors:</strong> Dahlia Wilson (Albany High School)
          <br />
        ...
        <p>
          <strong>Whereas,</strong> the labor movement must be central to any
          socialist strategy due to the structural power of the organized
          working class to extract concessions from the ruling class and the
          fact that unions are some of the most diverse working class
          institutions in the country. Labor organizing is both core to building
          socialist power and rooting the socialist movement in the multi-racial
          working class.
        </p>

        <p>
          <strong>Whereas,</strong> to rebuild the American labor and socialist
          movements, and to merge the two, socialists must have an orientation
          toward building shop floor power and developing a layer of
          rank-and-file leaders who can organize in the workplace on a
          day-to-day basis, often called the Rank-and-File Strategy (RFS). One
          key tactic of the RFS is having socialists take jobs in strategic, and
          often unionized, industries and workplaces.
        </p>

        <p>
          <strong>Whereas,</strong> YDSA has a particular role within the
          socialist movement to develop life-long committed socialist organizers
          and send them into broader socialist and workplace struggles. YDSAers,
          having often not yet started careers, are in a unique position to
          carry out the tactic of taking a Rank-and-File union job in a
          strategic industry upon graduation, and in some unique situations,
          while still in school. Other YDSA members may be entering sectors
          where unionization is low, but where socialists can play a leading
          role in cohering and activating a militant minority, carrying out
          successful union drives, and increasing class consciousness amongst
          their coworkers.
        </p>

        <p>
          <strong>Whereas,</strong> a number of YDSAers have already committed
          to pursuing the RFS as individuals, but have not had organizational
          support in this pursuit. By providing organizational support, those
          pursuing the RFS will be provided with mentorship, guidance, and a
          network of other socialists similarly pursuing the RFS in their
          preferred industry.
        </p>

        <p>
          <strong>Whereas,</strong> many YDSA members are unable to
          industrialize or salt, but should nonetheless be provided with a
          socialist understanding of and orientation toward the labor movement.
          In all different conditions YDSAers should be encouraged and supported
          to take up efforts to support labor struggles in their campuses and
          communities, and provided with the knowledge, perspective, and
          connections to engage in new organizing in their workplaces
          post-graduation.
        </p>

        <p>
          <strong>Therefore be it resolved,</strong> YDSA will renew its
          commitment to the rank-and-file strategy as it was prioritized in
          National DSA Resolution 32, which emphasizes that the central focus of
          socialists “should be on identifying and developing a layer of rank
          and file leaders who can organize in the workplace on a day-to-day
          basis.”
        </p>
        ...
        <ol>
          <li>
            Working with the National Political Education Committee to develop a
            curriculum around labor organizing and the rank-and-file strategy as
            part of the YDSA School of Socialism
          </li>
          <li>
            Running a national speaking tour for DSA labor organizers to speak
            to YDSA chapters in their region.
          </li>
          <li>Prioritizing labor as a topic for NPEC national calls</li>
        </ol>
        ...
        <ol>
          <li>
            A yearly survey of all YDSA members to map out if members are
            interested in entering the labor movement upon graduation and which
            industries/in what capacity
            <ul>
              <li>
                This yearly survey data, along with information about DSA
                chapters with strong labor formations, should be used to map out
                “hot spots,” prioritizing state schools, community colleges,
                trade schools, and HBCUs/HSIs and connecting them to their local
                DSA labor formation
              </li>
            </ul>
          </li>
          <li>
            Developing more pamphlets and educational materials like “Why
            Socialists should become Teachers” for more strategic industries
            such as logistics and healthcare
          </li>
          <li>
            Hosting national interest calls geared toward different industries
            with panels of rank-and-file organizers in the respective industry
          </li>
          <li>
            Hosting more in depth, recurring, rank-and-file schools for YDSAers
            nearing graduation who are seriously considering entering
            rank-and-file union jobs in strategic industries or salting
            unorganized workplaces, to connect them with labor organizers in the
            respective industry. These schools would cover the history of
            organizing in the industry and the contemporary terrain, provide
            workplace-specific organizing trainings, guide YDSAers in applying
            for these jobs, and connect them with pre-existing rank-and-file
            networks, caucuses, and organizers
          </li>
        </ol>
        ...
        <p>
          <strong>Be it finally resolved,</strong> YDSA recommits to campus
          labor organizing as an organizational priority, but will house said
          organizing work under the purview of relevant YDSA priority political
          campaigns. When necessary, the NLC will help connect YDSA members on
          different campuses who are engaged in campus labor organizing with
          each other and with experienced DSA labor organizers, and may hold
          national calls on the topic of campus labor organizing.
        </p>
      </Element>
      <Element
        name="growth-and-diversification"
        id="growth-and-diversification"
      >
        <h2>Growth and Diversification</h2>
        <h3>
          <strong>Sponsor:</strong> Labiba Chowdhury
          <br />
          <strong>Co-sponsors:</strong> Cerena Ermitanio
          <br /> Kristen Cervero
        </h3>
        ...
        <p>
          <strong>Whereas,</strong> as the youth section of the country’s
          largest socialist organization and in a time where there is mass
          unrest in response to racial injustice and police brutality, it is
          imperative that we do everything we can to be truly reflective of the
          working class.
        </p>

        <p>
          <strong>Whereas,</strong> DSA as a whole has struggled with a lack of
          diversity, particularly in regards to race, thus hindering our ability
          to be reflective of the working class’ multiracial nature.
        </p>

        <p>
          <strong>Whereas,</strong> YDSA has found particular success in
          diversifying our organization in a way that also roots us in the
          working class by investing in developing chapters at community
          colleges, Historically Black Colleges and Universities, and Minority
          Serving Institutions.
        </p>

        <p>
          <strong>Whereas,</strong> YDSA has grown tremendously since 2016 from
          12 to 115 chapters at high schools, universities, community colleges,
          and HBCUs.
        </p>

        <p>
          <strong>Whereas,</strong> YDSA has proven itself to be a key component
          for growing and diversifying DSA and the socialist movement as a
          whole, and in order to achieve DSA’s goal of 100,000-person
          membership, we must invest material resources into our organization.
        </p>

        <p>
          <strong>Whereas,</strong> this is all to say we must intentionally
          recruit and train organizers at community colleges and HBCUs in
          particular so that we may improve our organizing, improve our
          representation of the working class, aid in unifying class struggle
          around both universal and particular struggles, and ultimately aid in
          creating a unified socialist movement that is anti-racist in action,
        ...
        <ol>
          <li>
            Providing resources and material support for chapters so they can
            help form chapters in nearby community colleges, HBCUs, and high
            schools. These resources may include trainings on how to canvass a
            school; how to develop leaders; and trainings on how to use these
            various materials.
          </li>
          <li>
            Connecting YDSA chapters to corresponding DSA chapters in order to
            strengthen connections between YDSA and DSA chapters.
          </li>
          <li>
            Pulling a list of DSA members who attend community colleges, HBCUs,
            and MSIs without YDSA chapters and executing targeted outreach
            towards these members in the hopes that they will establish chapters
            at their institutions.
          </li>
          <li>
            Continuing to improve upon and execute the YDSA liaison program.
          </li>
          <li>
            Continuing to collaborate with AFROSOC to build chapters at HBCUs.
          </li>
        </ol>
        <p>
          <strong>Be it further resolved,</strong> DSA’s Growth and Development
          committee is encouraged to thoughtfully and intentionally integrate
        ...
        <p>
          ...
          who will be better equipped to recruit and develop organizers at
